...
@JsonKey(name: 'doctor_id') String? get doctorId;@JsonKey(name: 'name_ar') String? get nameAr;@JsonKey(name: 'name_en') String? get nameEn; String? get name;@JsonKey(name: 'specialization_id') String? get specializationId;@JsonKey(name: 'specialization_name') String? get specializationName;@JsonKey(name: 'specialization_icon') String? get specializationIcon; String? get gender; String? get phone; String? get email;@JsonKey(name: 'license_number') String? get licenseNumber;@JsonKey(name: 'experience_years') int get experienceYears;@JsonKey(name: 'consultation_fee') num get consultationFee; String? get bio;@JsonKey(name: 'image_url') String? get imageUrl;@JsonKey(name: 'qualification_files') List<String> get qualificationFiles;@JsonKey(name: 'is_active') bool get isActive; num get rating;@JsonKey(name: 'patients_count') int get patientsCount; List<ClinicDoctorScheduleModel> get schedules;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,doctorId,nameAr,nameEn,name,specializationId,specializationName,specializationIcon,gender,phone,email,licenseNumber,experienceYears,consultationFee,bio,imageUrl,const DeepCollectionEquality().hash(qualificationFiles),isActive,rating,patientsCount,const DeepCollectionEquality().hash(schedules)]);

@override
String toString() {
  return 'ClinicDoctorModel(doctorId: $doctorId, nameAr: $nameAr, nameEn: $nameEn, name: $name, specializationId: $specializationId, specializationName: $specializationName, specializationIcon: $specializationIcon, gender: $gender, phone: $phone, email: $email, licenseNumber: $licenseNumber, experienceYears: $experienceYears, consultationFee: $consultationFee, bio: $bio, imageUrl: $imageUrl, qualificationFiles: $qualificationFiles, isActive: $isActive, rating: $rating, patientsCount: $patientsCount, schedules: $schedules)';
}
...
@useResult
$Res call({
@JsonKey(name: 'doctor_id') String? doctorId,@JsonKey(name: 'name_ar') String? nameAr,@JsonKey(name: 'name_en') String? nameEn, String? name,@JsonKey(name: 'specialization_id') String? specializationId,@JsonKey(name: 'specialization_name') String? specializationName,@JsonKey(name: 'specialization_icon') String? specializationIcon, String? gender, String? phone, String? email,@JsonKey(name: 'license_number') String? licenseNumber,@JsonKey(name: 'experience_years') int experienceYears,@JsonKey(name: 'consultation_fee') num consultationFee, String? bio,@JsonKey(name: 'image_url') String? imageUrl,@JsonKey(name: 'qualification_files') List<String> qualificationFiles,@JsonKey(name: 'is_active') bool isActive, num rating,@JsonKey(name: 'patients_count') int patientsCount, List<ClinicDoctorScheduleModel> schedules
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'doctor_id')  String? doctorId, @JsonKey(name: 'name_ar')  String? nameAr, @JsonKey(name: 'name_en')  String? nameEn,  String? name, @JsonKey(name: 'specialization_id')  String? specializationId, @JsonKey(name: 'specialization_name')  String? specializationName, @JsonKey(name: 'specialization_icon')  String? specializationIcon,  String? gender,  String? phone,  String? email, @JsonKey(name: 'license_number')  String? licenseNumber, @JsonKey(name: 'experience_years')  int experienceYears, @JsonKey(name: 'consultation_fee')  num consultationFee,  String? bio, @JsonKey(name: 'image_url')  String? imageUrl, @JsonKey(name: 'qualification_files')  List<String> qualificationFiles, @JsonKey(name: 'is_active')  bool isActive,  num rating, @JsonKey(name: 'patients_count')  int patientsCount,  List<ClinicDoctorScheduleModel> schedules)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ClinicDoctorModel() when $default != null:
return $default(_that.doctorId,_that.nameAr,_that.nameEn,_that.name,_that.specializationId,_that.specializationName,_that.specializationIcon,_that.gender,_that.phone,_that.email,_that.licenseNumber,_that.experienceYears,_that.consultationFee,_that.bio,_that.imageUrl,_that.qualificationFiles,_that.isActive,_that.rating,_that.patientsCount,_that.schedules);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: 'doctor_id')  String? doctorId, @JsonKey(name: 'name_ar')  String? nameAr, @JsonKey(name: 'name_en')  String? nameEn,  String? name, @JsonKey(name: 'specialization_id')  String? specializationId, @JsonKey(name: 'specialization_name')  String? specializationName, @JsonKey(name: 'specialization_icon')  String? specializationIcon,  String? gender,  String? phone,  String? email, @JsonKey(name: 'license_number')  String? licenseNumber, @JsonKey(name: 'experience_years')  int experienceYears, @JsonKey(name: 'consultation_fee')  num consultationFee,  String? bio, @JsonKey(name: 'image_url')  String? imageUrl, @JsonKey(name: 'qualification_files')  List<String> qualificationFiles, @JsonKey(name: 'is_active')  bool isActive,  num rating, @JsonKey(name: 'patients_count')  int patientsCount,  List<ClinicDoctorScheduleModel> schedules)  $default,) {final _that = this;
switch (_that) {
case _ClinicDoctorModel():
return $default(_that.doctorId,_that.nameAr,_that.nameEn,_that.name,_that.specializationId,_that.specializationName,_that.specializationIcon,_that.gender,_that.phone,_that.email,_that.licenseNumber,_that.experienceYears,_that.consultationFee,_that.bio,_that.imageUrl,_that.qualificationFiles,_that.isActive,_that.rating,_that.patientsCount,_that.schedules);case _:
  throw StateError('Unexpected subclass');
...
class _ClinicDoctorModel implements ClinicDoctorModel {
  const _ClinicDoctorModel({@JsonKey(name: 'doctor_id') this.doctorId, @JsonKey(name: 'name_ar') this.nameAr, @JsonKey(name: 'name_en') this.nameEn, this.name, @JsonKey(name: 'specialization_id') this.specializationId, @JsonKey(name: 'specialization_name') this.specializationName, @JsonKey(name: 'specialization_icon') this.specializationIcon, this.gender, this.phone, this.email, @JsonKey(name: 'license_number') this.licenseNumber, @JsonKey(name: 'experience_years') this.experienceYears = 0, @JsonKey(name: 'consultation_fee') this.consultationFee = 0, this.bio, @JsonKey(name: 'image_url') this.imageUrl, @JsonKey(name: 'qualification_files') final  List<String> qualificationFiles = const <String>[], @JsonKey(name: 'is_active') this.isActive = false, this.rating = 0, @JsonKey(name: 'patients_count') this.patientsCount = 0, final  List<ClinicDoctorScheduleModel> schedules = const <ClinicDoctorScheduleModel>[]}): _qualificationFiles = qualificationFiles,_schedules = schedules;
...
/// Create a copy of ClinicDoctorModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? doctorId = freezed,Object? nameAr = freezed,Object? nameEn = freezed,Object? name = freezed,Object? specializationId = freezed,Object? specializationName = freezed,Object? specializationIcon = freezed,Object? gender = freezed,Object? phone = freezed,Object? email = freezed,Object? licenseNumber = freezed,Object? experienceYears = null,Object? consultationFee = null,Object? bio = freezed,Object? imageUrl = freezed,Object? qualificationFiles = null,Object? isActive = null,Object? rating = null,Object? patientsCount = null,Object? schedules = null,}) {
