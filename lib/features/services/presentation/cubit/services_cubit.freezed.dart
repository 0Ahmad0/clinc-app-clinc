...
@override
String toString() {
  return 'ServicesState(kind: $kind, detail: $detail, labSections: $labSections, selectedLabSectionIds: $selectedLabSectionIds, failure: $failure, isLoading: $isLoading, isMutating: $isMutating, labSearch: $labSearch, specializationSearch: $specializationSearch, labTestPriceDrafts: $labTestPriceDrafts, labSectionEnabledCounts: $labSectionEnabledCounts, busyLabTestIds: $busyLabTestIds, busySpecializationIds: $busySpecializationIds, version: $version, availableLabTests: $availableLabTests, enabledLabTests: $enabledLabTests, availableSpecializations: $availableSpecializations, enabledSpecializations: $enabledSpecializations)';
}
...
class _ServicesState extends ServicesState {
  const _ServicesState({required this.kind, this.detail, final  List<ClinicLabSectionModel> labSections = const [], final  Set<int> selectedLabSectionIds = const {}, this.failure, this.isLoading = false, this.isMutating = false, this.labSearch = '', this.specializationSearch = '', final  Map<int, String> labTestPriceDrafts = const {}, final  Map<int, int> labSectionEnabledCounts = const {}, final  Set<int> busyLabTestIds = const {}, final  Set<int> busySpecializationIds = const {}, this.version = 0, required this.availableLabTests, required this.enabledLabTests, required this.availableSpecializations, required this.enabledSpecializations}): _labSections = labSections,_selectedLabSectionIds = selectedLabSectionIds,_labTestPriceDrafts = labTestPriceDrafts,_labSectionEnabledCounts = labSectionEnabledCounts,_busyLabTestIds = busyLabTestIds,_busySpecializationIds = busySpecializationIds,super._();
