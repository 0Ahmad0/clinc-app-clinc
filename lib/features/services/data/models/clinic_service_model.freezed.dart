...
@JsonKey(name: 'section_id', fromJson: _intFromJson) int? get sectionId; String? get slug; String? get name;@JsonKey(name: 'name_ar') String? get nameAr;@JsonKey(name: 'name_en') String? get nameEn; String? get description; String? get icon;@JsonKey(name: 'is_active', fromJson: _boolFromJson) bool get isActive;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,sectionId,slug,name,nameAr,nameEn,description,icon,isActive);

@override
String toString() {
  return 'ClinicLabSectionModel(sectionId: $sectionId, slug: $slug, name: $name, nameAr: $nameAr, nameEn: $nameEn, description: $description, icon: $icon, isActive: $isActive)';
}
...
@useResult
$Res call({
@JsonKey(name: 'section_id', fromJson: _intFromJson) int? sectionId, String? slug, String? name,@JsonKey(name: 'name_ar') String? nameAr,@JsonKey(name: 'name_en') String? nameEn, String? description, String? icon,@JsonKey(name: 'is_active', fromJson: _boolFromJson) bool isActive
});
...
/// Create a copy of ClinicLabSectionModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? sectionId = freezed,Object? slug = freezed,Object? name = freezed,Object? nameAr = freezed,Object? nameEn = freezed,Object? description = freezed,Object? icon = freezed,Object? isActive = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'section_id', fromJson: _intFromJson)  int? sectionId,  String? slug,  String? name, @JsonKey(name: 'name_ar')  String? nameAr, @JsonKey(name: 'name_en')  String? nameEn,  String? description,  String? icon, @JsonKey(name: 'is_active', fromJson: _boolFromJson)  bool isActive)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ClinicLabSectionModel() when $default != null:
return $default(_that.sectionId,_that.slug,_that.name,_that.nameAr,_that.nameEn,_that.description,_that.icon,_that.isActive);case _:
  return orElse();
...
class _ClinicLabSectionModel implements ClinicLabSectionModel {
  const _ClinicLabSectionModel({@JsonKey(name: 'section_id', fromJson: _intFromJson) this.sectionId, this.slug, this.name, @JsonKey(name: 'name_ar') this.nameAr, @JsonKey(name: 'name_en') this.nameEn, this.description, this.icon, @JsonKey(name: 'is_active', fromJson: _boolFromJson) this.isActive = false});
...
/// Create a copy of ClinicLabSectionModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? sectionId = freezed,Object? slug = freezed,Object? name = freezed,Object? nameAr = freezed,Object? nameEn = freezed,Object? description = freezed,Object? icon = freezed,Object? isActive = null,}) {
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,labTestId,code,name,nameAr,nameEn,description,sectionId,sectionSlug,sectionName,defaultPrice,isActive);

@override
String toString() {
  return 'ClinicAvailableLabTestModel(labTestId: $labTestId, code: $code, name: $name, nameAr: $nameAr, nameEn: $nameEn, description: $description, sectionId: $sectionId, sectionSlug: $sectionSlug, sectionName: $sectionName, defaultPrice: $defaultPrice, isActive: $isActive)';
}
...
switch (_that) {
case _ClinicAvailableLabTestModel() when $default != null:
return $default(_that.labTestId,_that.code,_that.name,_that.nameAr,_that.nameEn,_that.description,_that.sectionId,_that.sectionSlug,_that.sectionName,_that.defaultPrice,_that.isActive);case _:
  return orElse();
...
class _ClinicAvailableLabTestModel implements ClinicAvailableLabTestModel {
  const _ClinicAvailableLabTestModel({@JsonKey(name: 'lab_test_id', fromJson: _intFromJson) this.labTestId, this.code, this.name, @JsonKey(name: 'name_ar') this.nameAr, @JsonKey(name: 'name_en') this.nameEn, this.description, @JsonKey(name: 'section_id', fromJson: _intFromJson) this.sectionId, @JsonKey(name: 'section_slug') this.sectionSlug, @JsonKey(name: 'section_name') this.sectionName, @JsonKey(name: 'default_price', fromJson: _numFromJson) this.defaultPrice, @JsonKey(name: 'is_active', fromJson: _boolFromJson) this.isActive = false});
...
@JsonKey(name: 'clinic_lab_test_id', fromJson: _intFromJson) int? get clinicLabTestId;@JsonKey(name: 'lab_test_id', fromJson: _intFromJson) int? get labTestId; String? get code; String? get name;@JsonKey(name: 'name_ar') String? get nameAr;@JsonKey(name: 'name_en') String? get nameEn;@JsonKey(name: 'section_id', fromJson: _intFromJson) int? get sectionId;@JsonKey(name: 'section_slug') String? get sectionSlug;@JsonKey(name: 'section_name') String? get sectionName;@JsonKey(fromJson: _numFromJson) num? get price;@JsonKey(name: 'default_price', fromJson: _numFromJson) num? get defaultPrice;@JsonKey(name: 'is_active', fromJson: _boolFromJson) bool get isActive;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,clinicLabTestId,labTestId,code,name,nameAr,nameEn,sectionId,sectionSlug,sectionName,price,defaultPrice,isActive);

@override
String toString() {
  return 'ClinicEnabledLabTestModel(clinicLabTestId: $clinicLabTestId, labTestId: $labTestId, code: $code, name: $name, nameAr: $nameAr, nameEn: $nameEn, sectionId: $sectionId, sectionSlug: $sectionSlug, sectionName: $sectionName, price: $price, defaultPrice: $defaultPrice, isActive: $isActive)';
}
...
switch (_that) {
case _ClinicEnabledLabTestModel() when $default != null:
return $default(_that.clinicLabTestId,_that.labTestId,_that.code,_that.name,_that.nameAr,_that.nameEn,_that.sectionId,_that.sectionSlug,_that.sectionName,_that.price,_that.defaultPrice,_that.isActive);case _:
  return orElse();
...
class _ClinicEnabledLabTestModel implements ClinicEnabledLabTestModel {
  const _ClinicEnabledLabTestModel({@JsonKey(name: 'clinic_lab_test_id', fromJson: _intFromJson) this.clinicLabTestId, @JsonKey(name: 'lab_test_id', fromJson: _intFromJson) this.labTestId, this.code, this.name, @JsonKey(name: 'name_ar') this.nameAr, @JsonKey(name: 'name_en') this.nameEn, @JsonKey(name: 'section_id', fromJson: _intFromJson) this.sectionId, @JsonKey(name: 'section_slug') this.sectionSlug, @JsonKey(name: 'section_name') this.sectionName, @JsonKey(fromJson: _numFromJson) this.price, @JsonKey(name: 'default_price', fromJson: _numFromJson) this.defaultPrice, @JsonKey(name: 'is_active', fromJson: _boolFromJson) this.isActive = false});
...
@JsonKey(name: 'specialization_id', fromJson: _intFromJson) int? get specializationId; String? get slug; String? get name;@JsonKey(name: 'name_ar') String? get nameAr;@JsonKey(name: 'name_en') String? get nameEn; String? get description; String? get icon;@JsonKey(name: 'is_active', fromJson: _boolFromJson) bool get isActive;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,specializationId,slug,name,nameAr,nameEn,description,icon,isActive);

@override
String toString() {
  return 'ClinicAvailableSpecializationModel(specializationId: $specializationId, slug: $slug, name: $name, nameAr: $nameAr, nameEn: $nameEn, description: $description, icon: $icon, isActive: $isActive)';
}
...
@useResult
$Res call({
@JsonKey(name: 'specialization_id', fromJson: _intFromJson) int? specializationId, String? slug, String? name,@JsonKey(name: 'name_ar') String? nameAr,@JsonKey(name: 'name_en') String? nameEn, String? description, String? icon,@JsonKey(name: 'is_active', fromJson: _boolFromJson) bool isActive
});
...
/// Create a copy of ClinicAvailableSpecializationModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? specializationId = freezed,Object? slug = freezed,Object? name = freezed,Object? nameAr = freezed,Object? nameEn = freezed,Object? description = freezed,Object? icon = freezed,Object? isActive = null,}) {
  return _then(_self.copyWith(
...
switch (_that) {
case _ClinicAvailableSpecializationModel() when $default != null:
return $default(_that.specializationId,_that.slug,_that.name,_that.nameAr,_that.nameEn,_that.description,_that.icon,_that.isActive);case _:
  return orElse();
...
class _ClinicAvailableSpecializationModel implements ClinicAvailableSpecializationModel {
  const _ClinicAvailableSpecializationModel({@JsonKey(name: 'specialization_id', fromJson: _intFromJson) this.specializationId, this.slug, this.name, @JsonKey(name: 'name_ar') this.nameAr, @JsonKey(name: 'name_en') this.nameEn, this.description, this.icon, @JsonKey(name: 'is_active', fromJson: _boolFromJson) this.isActive = false});
...
/// Create a copy of ClinicAvailableSpecializationModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? specializationId = freezed,Object? slug = freezed,Object? name = freezed,Object? nameAr = freezed,Object? nameEn = freezed,Object? description = freezed,Object? icon = freezed,Object? isActive = null,}) {
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,clinicSpecializationId,specializationId,slug,name,nameAr,nameEn,icon,isActive);

@override
String toString() {
  return 'ClinicEnabledSpecializationModel(clinicSpecializationId: $clinicSpecializationId, specializationId: $specializationId, slug: $slug, name: $name, nameAr: $nameAr, nameEn: $nameEn, icon: $icon, isActive: $isActive)';
}
...
/// Create a copy of ClinicEnabledSpecializationModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? clinicSpecializationId = freezed,Object? specializationId = freezed,Object? slug = freezed,Object? name = freezed,Object? nameAr = freezed,Object? nameEn = freezed,Object? icon = freezed,Object? isActive = null,}) {
  return _then(_self.copyWith(
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'clinic_specialization_id', fromJson: _intFromJson)  int? clinicSpecializationId, @JsonKey(name: 'specialization_id', fromJson: _intFromJson)  int? specializationId,  String? slug,  String? name, @JsonKey(name: 'name_ar')  String? nameAr, @JsonKey(name: 'name_en')  String? nameEn,  String? icon, @JsonKey(name: 'is_active', fromJson: _boolFromJson)  bool isActive)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ClinicEnabledSpecializationModel() when $default != null:
return $default(_that.clinicSpecializationId,_that.specializationId,_that.slug,_that.name,_that.nameAr,_that.nameEn,_that.icon,_that.isActive);case _:
  return orElse();
...
class _ClinicEnabledSpecializationModel implements ClinicEnabledSpecializationModel {
  const _ClinicEnabledSpecializationModel({@JsonKey(name: 'clinic_specialization_id', fromJson: _intFromJson) this.clinicSpecializationId, @JsonKey(name: 'specialization_id', fromJson: _intFromJson) this.specializationId, this.slug, this.name, @JsonKey(name: 'name_ar') this.nameAr, @JsonKey(name: 'name_en') this.nameEn, this.icon, @JsonKey(name: 'is_active', fromJson: _boolFromJson) this.isActive = false});
...
/// Create a copy of ClinicEnabledSpecializationModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? clinicSpecializationId = freezed,Object? specializationId = freezed,Object? slug = freezed,Object? name = freezed,Object? nameAr = freezed,Object? nameEn = freezed,Object? icon = freezed,Object? isActive = null,}) {
