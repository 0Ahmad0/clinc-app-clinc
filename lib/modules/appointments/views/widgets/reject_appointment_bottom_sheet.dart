    ...
    final reasons = <Map<String, String>>[
      {
        ...
        'label': tr(LocaleKeys.appointments_reject_reasons_doctor_unavailable),
      },
      {
        'key': 'clinic_closed',
        'label': tr(LocaleKeys.appointments_reject_reasons_clinic_closed),
      },
      {
        'key': 'invalid_booking',
        'label': tr(LocaleKeys.appointments_reject_reasons_invalid_booking),
      },
      {
        'key': 'need_more_info',
        'label': tr(LocaleKeys.appointments_reject_reasons_need_more_info),
      },
          ...
          children: [
            ...
            Obx(
              () => DropdownButtonFormField<String>(
                ...
                validator: (_) => (reasonKey.value == null)
                    ? tr(
                        LocaleKeys
                            .appointments_reject_validation_reason_required,
                      )
                    : null,
            ...
            TextFormField(
              ...
              validator: (v) {
                ...
                if (txt.isEmpty)
                  return tr(
                    LocaleKeys.appointments_reject_validation_note_required,
                  );
                return null;
              },
              decoration: InputDecoration(
