...
class AdsController extends GetxController {
  ...
  void completePayment() {
    ...
    final duration = flow == AdFlowType.single ? const Duration(days: 7) : const Duration(days: 30);
  ...
  String remainingForAd(AdCampaign ad) {
    ...
    if (days > 0) {
      return tr('ads.status.remaining_days_hours', args: [days.toString(), hours.toString()]);
    }
    final minutes = diff.inMinutes.remainder(60);
    return tr('ads.status.remaining_hours_minutes', args: [hours.toString(), minutes.toString()]);
  }
  ...
  bool _isFormValid() {
    ...
    if (selectedFlowType.value == AdFlowType.package && selectedPackageId.value.isEmpty) {
