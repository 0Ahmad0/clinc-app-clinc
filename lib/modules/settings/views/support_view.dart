...
class SupportView extends StatelessWidget {
                ...
                _SectionCard(
                  ...
                  children: const [
                    _FaqItem(
                      ...
                      answer:
                          'من الشاشة الرئيسية، اضغط على "المواعيد" ثم زر الإضافة (+) لإنشاء موعد جديد وتعبئة بيانات المريض والطبيب والوقت.',
                    ),
                    _FaqItem(
                      question: 'كيف أعدّل بيانات طبيب؟',
                      answer:
                          'انتقل إلى قسم "الأطباء"، اضغط على بطاقة الطبيب المراد تعديله، ثم اختر "تعديل" من القائمة.',
                    ),
                    _FaqItem(
                      question: 'كيف أصدّر تقرير؟',
                      answer:
                          'ادخل قسم "التقارير"، حدد نوع التقرير والفترة الزمنية، ثم اضغط على "تصدير PDF" أو "تصدير CSV".',
                    ),
                    _FaqItem(
                      question: 'هل يمكنني استخدام التطبيق بدون إنترنت؟',
                      answer:
                          'يعمل التطبيق بشكل جزئي بدون إنترنت، لكن بعض الميزات مثل المزامنة والإشعارات تتطلب اتصالاً بالشبكة.',
                    ),
                  ],
                ),
                20.verticalSpace,
                  ...
                  children: [
                    _ContactTile(
                      ...
                      onTap: () => _launchSupportUri(
                        Uri(
                          scheme: 'mailto',
                          path: 'support@clinicapp.com',
                          query: 'subject=Clinic App Support',
                        ),
                      ),
                    ),
                    const _HorizDivider(),
                    _ContactTile(
                      ...
                      onTap: () => _launchSupportUri(
                        Uri(scheme: 'tel', path: '+966500000000'),
                      ),
                    ),
                    const _HorizDivider(),
                    _ContactTile(
  ...
  Future<void> _launchSupportUri(Uri uri) async {
    ...
    if (!launched) {
      ResponseHelper.onFailure(message: 'تعذر فتح رابط الدعم');
    }
  }
}
