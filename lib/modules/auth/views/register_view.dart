...
class RegisterView extends GetView<RegisterController> {
  ...
  Widget build(BuildContext context) {
    ...
    // استخدام AppScaffoldWidget مع التعديلات الجديدة
            ...
            Expanded(
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    24.verticalSpace,
                    // دمج بين القديم والجديد - استخدام الـ selector الجديد مع الربط القديم
                    _AccountTypeCard(controller: controller),
                    16.verticalSpace,
                    // استخدام الـ form الجديد مع الربط القديم
                    _FormCard(controller: controller),
                    20.verticalSpace,
                    // دمج الأزرار من القديم والجديد
                    Obx(
                      () => _GradientAuthButton(
                    ...
                    20.verticalSpace,
                    // إضافة رابط تسجيل الدخول من الواجهة الجديدة
                    Row(
  ...
  // Header جديد من الواجهة المحدثة
  Widget _buildHeader() {
    return Container(
...
// ============== ويدجت نوع الحساب (مدمج من الجديد) ==============
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          14.verticalSpace,
          // الربط مع الـ controller من الكود القديم
          Obx(
            () => Row(
              children: [
                Expanded(
                  child: _TypeTile(
                    ...
                    color: _indigo,
                    onTap: () =>
                        controller.selectAccountType(AccountType.clinic),
                  ),
                ),
                10.horizontalSpace,
                Expanded(
                ...
                Expanded(
                  child: _TypeTile(
                    ...
                    selected:
                        controller.selectedAccountType.value == AccountType.lab,
...
// ============== ويدجت الفورم (مدمج من الجديد مع ربط القديم) ==============
        ...
        child: Column(
          ...
          children: [
            ...
            _AuthField(
              ...
              label: tr(LocaleKeys.register_fields_email_hint),
...
// ============== ويدجت حقل الإدخال (مدمج من الجديد) ==============
