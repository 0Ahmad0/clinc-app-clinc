...
class OtpView extends GetView<OtpController> {
            ...
            Expanded(
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    32.verticalSpace,
                    // دمج بين القديم والجديد - استخدام الـ OTP Card الجديد مع الربط القديم
            ...
            Padding(
              ...
              child: RichText(
                ...
                text: TextSpan(
                  ...
                  children: [
                    TextSpan(
                      // ربط مع الـ controller من الكود القديم
  ...
  Widget _buildOtpCard(BuildContext context) {
    ...
    final focusedTheme = defaultTheme.copyWith(
      decoration: defaultTheme.decoration!.copyWith(
        border: const Border.fromBorderSide(
          BorderSide(color: _teal, width: 2.0),
        ),
    ...
    return Container(
      ...
      child: Column(
        children: [
          // حقل إدخال OTP الجديد مع ربط قديم
          Pinput(
            autofocus: true,
          ...
          28.verticalSpace,
          // مؤقت إعادة الإرسال الجديد مع ربط قديم
          Obx(() {
...
// ============== ويدجت زر OTP (من الواجهة الجديدة) ==============
