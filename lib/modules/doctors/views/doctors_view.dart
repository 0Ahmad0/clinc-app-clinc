    ...
    return Scaffold(
      ...
      body: NestedScrollView(
        headerSliverBuilder: (ctx, _) => [
          // الهيدر الجديد مع الربط القديم
          SliverToBoxAdapter(child: _DoctorsHeader()),
          // شريط البحث والفلتر (جديد)
        ...
        body: Obx(() {
          // استخدام displayedDoctors من الكود الجديد
          ...
          return RefreshIndicator(
            ...
            child: ListView.separated(
              ...
              itemBuilder: (_, i) => DoctorCard(
                doctorModel: list[i],
                onTap: () => controller.goToDoctorDetailsNew(list[i]),
...
// ===== فلتر التخصصات (جديد مع ربط قديم) =====
class _SpecialtyFilters extends GetView<DoctorsController> {
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() {
      final specialties = controller.specializations;
      final selected = controller.selectedSpecializationId.value;
      ...
      return SingleChildScrollView(
        ...
        child: Row(
          children: [
            _SpecialtyChip(
              label: tr('doctors_page.filters.all'),
              selected: selected == null,
              color: const Color(0xFF3949AB),
              onTap: () => controller.selectSpecialization(null),
              theme: theme,
              cs: cs,
            ),
            ...specialties.map((s) {
              final color = _specialtyColor('${s.id}');
              ...
              return Padding(
                ...
                child: _SpecialtyChip(
                  ...
                  color: color,
                  onTap: () => controller.selectSpecialization(s.id),
                  theme: theme,
                  cs: cs,
                ),
              );
  ...
  Color _specialtyColor(String id) {
    final colors = [
